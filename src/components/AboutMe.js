    ...
    return (
        <div id='AboutMe' className='section sectionFlexSimple'>
            <div id="aboutTitleCont">
                ...
                <button className="button" onClick={() => {window.open('https://drive.google.com/file/d/1geqX7X4WpHzCf91lPROTVfgX3WovLw4r/view?usp=sharing', '_blank')}}>DOWNLOAD CV</button>
            </div>
